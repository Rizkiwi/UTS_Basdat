                ...
                <section class="getintouch">
                    <div class="container modern-form" style="padding-top: 0px;">
                        <div class="text-center">
                            <h4 style="color: #212529;font-size: 45px;">Team</h4>
                        </div>
                            ...
                            <form action="{{ route('tim') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="text" placeholder="Nama tim" name="Nama_Tim">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="text" placeholder="Kota asal" name="Kota_asal">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="date" placeholder="Tahun berdiri" name="Tahun_berdiri">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="text" placeholder="Asal negara" name="Asal_negara">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3">
                                            <select class="form-control input input-tr" name="ID_Kompetisi">
                                                <option value="">Pilih Kompetisi </option>
                                                @foreach($kompetisiList as $kompetisi)
                                                    <option value="{{ $kompetisi->ID_Kompetisi }}">{{ $kompetisi->Nama_Kompetisi }}</option>
                                                @endforeach
                                            </select>
                                            <div class="line-box">
                                                <div class="line"></div>
