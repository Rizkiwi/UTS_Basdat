                            ...
                            <table class="table">
                                <thead>
                                    <tr class="text-center">
                                        <th style="width: 400px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Nama</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Usia</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Tinggi</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Berat</th>
                                        <th style="background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Posisi</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Gol</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Assist</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Saves</th>
                                        <th style="width: 70px;background: rgba(55,99,244,0.8);color: rgb(255,255,255);">Cleansheets</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if (count($statistics))
                                        ...
                                        <td>{{$statistic->Jumlah_Pertandingan}}</td>
