                                    ...
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        <thead class="thead-dark">
                                            <tr class="justify-content-center align-items-center align-content-center">
                                                ...
                                                <th class="text-center">Jumlah pertandingan</th>
                                                <th class="text-center">gol</th>
                                                <th class="text-center">assist</th>
                                                <th class="text-center">kartu kuning</th>
                                                <th class="text-center">kartu merah</th>
                                                <th class="text-center">penyelamatan</th>
