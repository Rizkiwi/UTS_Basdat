                                    ...
                                    <table class="table table-striped table tablesorter" id="ipi-table">
                                        <thead class="thead-dark">
                                            <tr class="justify-content-center align-items-center align-content-center">
                                                ...
                                                <th class="text-center">tim tuan rumah</th>
                                                <th class="text-center">tim tamu</th>
                                                <th class="text-center">skor tuan rumah</th>
                                                <th class="text-center">skor tamu</th>
                                                <th class="text-center">jumlah penonton</th>
