...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;padding-top: 0px;margin-top: 0px;">
    ...
    <section class="py-5">
        <div class="row text-center d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center"><figure class="snip1527">
...
<figure class="snip1527">
  ...
  <a href="#"></a>
        ...
        <div class="row text-center d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
            <div class="col" style="padding-right: 27px;margin-right: -20px;margin-left: -100px;"><div class="container justify-content-lg-center">
  <div class="row justify-content-lg-center">
    <div class="col-md-6 col-lg-4 col-xl-3">
      <figure class="snip1527">
        <div class="image"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/pr-sample25.jpg"
            alt="pr-sample25" /></div>
        <figcaption>
          <div class="date"><span class="day">01</span><span class="month">Dec</span></div>
          <h3>Down with this sort of thing</h3>
